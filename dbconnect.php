...
if ($row['Email'] != $email_admin) {
    $sql =  "INSERT INTO $table_employees(First_Name,Surname,Password,Email,Permissions,Mobile_Number,Session_ID) VALUES('$first_name_admin','$surname_admin','$password_admin','$email_admin','$permissions_admin','','')";
    ...
    if ($row_2['Email'] != $email_brigadnici) {
        ...
        if (!mysqli_query($db, "INSERT INTO $table_employees(First_Name,Surname,Password,Email,Permissions,Change_Number,Mobile_Number,Session_ID) VALUES('a','h','j','k','k','9999','','')")) {
