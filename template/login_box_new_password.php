                ...
                <form method="post">
                    <div class="row collapse">
                        <div class="small-10 medium-10 large-10 columns">
                            <input type="password" onblur="if (this.placeholder == '') {this.placeholder = 'Zadajte nové heslo';}" onfocus="this.placeholder = '';" placeholder="Zadajte nové heslo" name='newPass' required/>
                        </div>
                        ...
                        <div class="small-10 medium-10 large-10 columns">
                            <input type="password" onblur="if (this.value == '') {this.placeholder = 'Znovu zadejte nové heslo';}" onfocus="this.placeholder = '';" placeholder="Znovu zadejte nové heslo" name='checkNewPass' required/>
                        </div>
                        <div class="small-2 medium-2 large-2 columns">
                            <span class="postfix custom">
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
