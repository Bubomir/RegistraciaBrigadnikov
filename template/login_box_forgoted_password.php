                ...
                <form method='post'>
                    <div class="row collapse">
                        <div class="small-10 medium-10 large-10 columns">
                            <input type="email" onblur="if (this.placeholder == '') {this.placeholder = 'Vaše e-mailová adresa';}" onfocus="this.placeholder = '';" placeholder="Vaše e-mailová adresa" name="email" required/>
                        </div>
